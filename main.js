(function() {
  ...
  itinerary = [
    ...
    { dist: 4, cdist: 69, day: 7, text: 'Společnost minula východní okraj Starého Hvozdu.' },
    { dist: 6, cdist: 75, day: 7, text: 'Společnost se utábořila na noc. Ráno pokračovali volným tempem na východ. Daleko na jihu se objevily nejzápadnější svahy Mohylových vrchů.' },
    { dist: 6, cdist: 81, day: 8, text: 'Společnost míjela Mohylové vrchy. Mezi Cestou a vrchy se tyčily křoviny.' },
    ...
    { dist: 1, cdist: 86, day: 9, text: 'Společnost dorazila k jižní bráně a opustili vesnici Hůrku. Pokračovali na východ po Velké východní cestě.' },
    { dist: 5, cdist: 91, day: 9, text: 'Společnost se utábořila u stezky vedoucí na sever k Hustolesu na Hůreckém kopci. Ráno pokračovali volným tempem na východ. Cesta se stáčela na východo-jihovýchod okrajem Hustolesa.' },
    ...
    { dist: 6, cdist: 107, day: 11, text: 'Společnost projela východním okrajem Hustolesa. Na jihu viděli statky roztroušené po krajině.' },
    ...
    { dist: 8, cdist: 133, day: 13, text: 'Společnost po cestě minula pospíchajícího cestovatele.' },
    { dist: 4, cdist: 137, day: 13, text: 'Cesta se přiblížila k močálům na severu. Společnost se utábořila na noc. Ráno pokračovali na východo-jihovýchod pohodlným tempem. Počasí se toho dne vydařilo.' },
    { dist: 6, cdist: 143, day: 14, text: 'Cesta se stočila zpět k východu a močály vyplňovaly celý severní obzor.' },
    { dist: 6, cdist: 149, day: 14, text: 'Společnost se utábořila na jih od Komářích močálů. Ráno pokračovali na východ pohodlným tempem.' },
    { dist: 6, cdist: 155, day: 15, text: 'Cesta společnosti pokračovala na východ okolo jižního okraje močálů.' },
    { dist: 5, cdist: 160, day: 15, text: 'Společnost se utábořila na jih od cesty, pryč od močálů, a ráno pokračovala na východ po Velké východní cestě.' },
    { dist: 5, cdist: 165, day: 16, text: 'Cesta se začala stáčet trochu víc na sever.' },
    { dist: 5, cdist: 170, day: 16, text: 'Společnost dorazila k jihovýchodnímu okraji Komářích močálů a utábořila se. Ráno pokračovali po Cestě, která se stáčela na severovýchod a zvolna do kopce.' },
    { dist: 5, cdist: 175, day: 17, text: 'Společnost před sebou v dáli spatřila Větrov. Větrovské vrchy byly viditelné směrem na sever.' },
    { dist: 5, cdist: 180, day: 17, text: 'Společnost se k večeru utábořila. Na obou stranách cesty se rozléhala drsná otevřená krajina. Počasí bylo příjemné. Ráno pokračovali pohodlným tempem na severovýchod po Cestě.' },
    { dist: 5, cdist: 185, day: 18, text: 'Krajina se stále pomalu svažovala do kopce směrem k Větrovu.' },
    { dist: 5, cdist: 190, day: 18, text: 'Větrov se tyčil stále blíž. Společnost se utábořila. Ráno pokračovali po Cestě na severovýchod pomalu do kopce.' },
    { dist: 5, cdist: 195, day: 19, text: 'Větrov se tyčil před projíždějící společností a vyplňoval celé její zorné pole.' },
    { dist: 5, cdist: 200, day: 19, text: 'Větrov se tyčil přímo na sever od Cesty. Společnost se utábořila na jeho úpatí. Ráno projížděli okolo Větrova na severovýchod.' },
    { dist: 5, cdist: 205, day: 20, text: 'Společnost projela jihovýchodní úpatí Větrova.' },
    ...
    { dist: 9, cdist: 255, day: 25, text: 'Společnost se utábořila a ráno pokračovala po Cestě na východ.' },
    { dist: 9, cdist: 264, day: 26, text: 'Společnost se utábořila a ráno pokračovala na východ. Daleko za nimi byly Větrovské vrchy stále méně viditelné. Před sebou společnost zpozorovala vrcholky Obřích lesů.' },
    { dist: 9, cdist: 273, day: 27, text: 'Společnost se utábořila a ráno pokračovala na východ. Cesta byla drsná.' },
    { dist: 9, cdist: 282, day: 28, text: 'Společnost se utábořila a ráno pokračovala na východ. Za nimi se Větrovské vrchy téměř úplně ztratily z dohledu. Před nimi se stále více tyčily zalesněné kopce.' },
    { dist: 9, cdist: 291, day: 29, text: 'Společnost se utábořila a ráno pokračovala v cestě otevřenou krajinou. V okolí se nenacházel žádný vodní tok.' },
    { dist: 9, cdist: 300, day: 30, text: 'Společnost se utábořila a ráno pokračovala po Cestě, která se stáčela více na jihovýchod. Na jih od cesty rostly keře a zakrslé stromy, divoké a neprůchodné.' },
    { dist: 9, cdist: 309, day: 31, text: 'Společnost se utábořila na sever od Cesty. Ráno pokračovali za příjemného počasí. Před nimi se tyčily Obří lesy.' },
    { dist: 8, cdist: 317, day: 32, text: 'Společnost se utábořila a ráno pokračovala po cestě, která se opět stočila na jihovýchod, skrz otevřenou krajinu. Vpředu na kopcích Obřích lesů pozorovali staré hrady zlověstného vzhledu.' },
    { dist: 6, cdist: 323, day: 33, text: 'Společnost se utábořila a ráno pokračovala na jihovýchod. Počasí se změnilo ve studené a mokré. Společnost dorazila k severovýchodnímu konci údolí na jihu od Cesty. Pokračovali dál. Velká východní cesta se stala jen rozbahněnou stezkou.' },
    { dist: 2, cdist: 325, day: 33, text: 'Společnost překročila Poslední most krátce před setměním. Zastavili se, aby se utábořili pod skupinou stromů, a zjistili, že Gandalf zmizel. Ztratili zásoby jídla, když se splašil poník a vběhl do řeky. Zahlédli oheň mezi stromy na svahu kopce směrem na východ a rozhodli se pro průzkum.' },
    { dist: 7, cdist: 332, day: 33, text: 'Společnost dorazila k ohni obtížnou cestou skrz stromy a narazila na zlobry. Padli do zajetí.' },
    { dist: 7, cdist: 339, day: 34, text: 'Objevil se Gandalf a lstí přiměl zlobry k hádce až do rána, kdy se s východem slunce proměnili v kámen. Společnost se vrátila z kopců na Velkou východní cestu. Pokračovali směrem na východ.' },
    { dist: 1, cdist: 340, day: 34, text: 'Cesta se stáčela opět na jihovýchod. Společnost projela úpatím kopců Obřích lesů.' },
    ...
    { dist: 2, cdist: 350, day: 35, text: 'Společnost vyjela do údolí na severu lesů.' },
    ...
    { dist: 3, cdist: 373, day: 36, text: 'Společnost se utábořila na noc. Ráno pokračovali na severovýchod. Cesta stále vede úpatím kopců Obřích lesů.' },
    { dist: 5, cdist: 378, day: 37, text: 'Společnost překročila potůček. Cesta se stočila více na severovýchod. Bouřná (Bruinen) je nedaleko na jih a teče také k východo-severovýchodu.' },
    ...
    { dist: 1, cdist: 397, day: 38, text: 'Společnost převedla poníky přes úzký můstek nad horním tokem Bouřné (Bruinen) a dorazila do Posledního domáckého domu v Roklince.' },
    { dist: 4, cdist: 401, day: 39, text: 'Společnost opustila Roklinku a vydala se na ponících do podhůří Mlžných hor.' },
    { dist: 4, cdist: 405, day: 40, text: 'Společnost se utábořila v podhůří Mlžných hor. Ráno pokračovali v cestě na ponících.' },
    { dist: 4, cdist: 409, day: 41, text: 'Společnost započala s poníky výstup do Mlžných hor.' },
